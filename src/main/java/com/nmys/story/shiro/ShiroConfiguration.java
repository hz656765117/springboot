...
//        filterChainDefinitionMap.put("/index/article/**", "anon");
//        filterChainDefinitionMap.put("/index/about/**", "anon");
//        filterChainDefinitionMap.put("/index/page/**", "anon");
//        filterChainDefinitionMap.put("/index/links/**", "anon");
//        filterChainDefinitionMap.put("/index/category/**", "anon");
//        filterChainDefinitionMap.put("/index/archives/**", "anon");
//        filterChainDefinitionMap.put("/index/search/**", "anon");
//        filterChainDefinitionMap.put("/index/tag/**", "anon");
//        filterChainDefinitionMap.put("/index/comment/**", "anon");
//        filterChainDefinitionMap.put("/index/soulPainter.html/**", "anon");
//        filterChainDefinitionMap.put("/index/custom/**", "anon");
